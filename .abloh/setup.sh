...
# step 1: dependencies, resolved - your repository commits no lockfile. From no committed package-lock.json - your own .gitignore:3:package-lock.json keeps it out of the commit
